      ...
      <section id="featured-events" className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            ...
            {/* Event Card 3 */}
            <div className="group bg-white rounded-3xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <div className="p-6">
                ...
                {!user ? (
                  ...
                  <Link
                    href="/checkout"
                    className="block w-full py-3 text-center text-sm font-medium text-white bg-black rounded-full hover:bg-gray-800 transition-colors"
                  >
                    Get Tickets
                  </Link>
                ) : (
