            ...
            <div className="hidden md:flex flex-1 items-center justify-end gap-3">
              {isGuest ? (
                ...
                <>
                  <Link
                    href="/signin"
                    className="btn-sm btn-animated bg-white text-gray-800 shadow-sm hover:bg-gray-50"
                  >
                    Login
                  </Link>
                  <Link
                    href="/signup"
                    className="btn-sm btn-animated bg-gray-800 text-gray-200 shadow-sm hover:bg-gray-900"
                  >
                    Register
                  </Link>
                </>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="btn-sm btn-animated bg-red-100 text-red-700 hover:bg-red-200 transition-colors"
                  >
                    Logout
                  </button>
                </div>
