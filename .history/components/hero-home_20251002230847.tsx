...
export default function HeroHome() {
  ...
  const handleEventClick = (eventId: string) => {
    console.log('Event card clicked:', eventId); // Debug log
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            ...
            <Link href="/event/rock-concert-2025" className="block">
              <div 
                className="group bg-white rounded-3xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100 cursor-pointer relative z-10"
                onClick={(e) => {
                  e.preventDefault();
                  handleEventClick('rock-concert-2025');
                }}
                role="button"
                tabIndex={0}
                onKeyDown={(e) => {
            ...
            {/* Event Card 2 */}
            <Link href="/event/tech-workshop" className="block">
              <div 
                className="group bg-white rounded-3xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100 cursor-pointer relative z-10"
                onClick={(e) => {
                  e.preventDefault();
                  handleEventClick('tech-workshop');
                }}
                role="button"
                tabIndex={0}
                onKeyDown={(e) => {
            ...
            {/* Event Card 3 */}
            <div 
              className="group bg-white rounded-3xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100 cursor-pointer"
              onClick={() => handleEventClick('art-exhibition')}
            >
